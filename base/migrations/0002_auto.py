...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field subjects_on_offer on 'TutorProfile'
        db.create_table('base_tutorprofile_subjects_on_offer', (
        ...
        db.create_unique('base_tutorprofile_subjects_on_offer', ['tutorprofile_id', 'subject_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field subjects_on_offer on 'TutorProfile'
        db.delete_table('base_tutorprofile_subjects_on_offer')
    ...
    models = {
        ...
        'base.tutorprofile': {
            ...
            'subjects_on_offer': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['base.Subject']", 'symmetrical': 'False'}),
